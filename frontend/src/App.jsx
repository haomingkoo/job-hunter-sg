...
import {
  Search, Briefcase, FileText, Plus, X, ChevronRight,
  CheckCircle, AlertCircle, Trash2, Edit3,
  RefreshCw, Zap, Download, Star,
  Loader2, LogOut,
  Sparkles, UploadCloud, Printer,
} from "lucide-react";

import { API_BASE, apiFetch, clearResumeDraftStorage } from "./lib/api.js";
import { escapeRegExp, titleCase, extractKeywordLabel, collectKeywordMatches, getScoreTheme } from "./lib/helpers.js";
