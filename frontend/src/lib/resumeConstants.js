...
export const RESUME_EDUCATION_INSTITUTION_RE = /\b(?:university|polytechnic|college|school|institute|academy|faculty|national university|nanyang|singapore management|nus|ntu|smu|sutd|sit|suss|temasek poly|ngee ann|republic poly|singapore poly|nyp|ite|kaplan|lasalle|nafa|sim global|psb academy|james cook|curtin|monash|stanford|mit|harvard|oxford|cambridge|imperial|eth|melbourne|sydney|tokyo|peking|tsinghua|hku|unsw)\b/i;
