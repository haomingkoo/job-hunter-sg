...
export const RESUME_ACTION_VERBS = new Set([
  ...
  "maximized", "maximised", "mentored", "merged", "migrated", "minimized", "minimised",
  "modernized", "modernised", "monitored", "motivated", "navigated", "negotiated",
  "operated", "optimized", "optimised", "orchestrated", "organized", "organised", "originated",
  ...
  "refined", "reformed", "regulated", "reorganized", "reorganised", "represented",
  ...
  "supervised", "surpassed", "sustained", "synchronized", "synchronised", "targeted",
...
export const RESUME_BULLET_RE = /^(\s*(?:(?:[-*\u2022\u2023\u25E6\u2043\u2219\u00B7\u25AA\u25AB\u25CF\uF0B7▪●]|\d+[.)])\s*|o\s+))(.*)$/;
...
export const RESUME_CERTIFICATION_RE = /certification|certifications|certificate|certified|\bpmp\b|\bwsq\b|skillsfuture|accredited|in progress|gmat|upskilling|emeritus|heicoders|completed.*course|full stack development|generative ai|currently pursuing/i;
